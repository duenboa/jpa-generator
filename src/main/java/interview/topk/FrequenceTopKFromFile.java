 ...
 * </pre>
 * @see interview.topk.FrequenceTopK 数组元素频次求topk
 */
public class FrequenceTopKFromFile {


    public static void main(String[] args) throws IOException {
        File file = new File("d://topkTest.txt");
        Map.Entry<String, Integer>[] topk = topk(file, 5);
        System.out.println(Arrays.toString(topk));
    }

    private static Map.Entry<String, Integer>[] topk(File file, int k) throws IOException {
        //读取文件里的字符串,构造数组
